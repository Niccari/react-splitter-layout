...
[![Coveralls](https://img.shields.io/coveralls/zesik/react-splitter-layout.svg)](https://coveralls.io/github/zesik/react-splitter-layout) - note: not supported on this fork.
...
The `SplitterLayout` component supports the following props. All props are optional.
